...
import sys #To exit from our game
import pygame
from pygame.locals import * #Pygame basic imports
...
def mainGame():
    ...
    #Creating our 2 pipes for blitting
    ...
    while True:
        ...
        #Add a new pipe when first is about to cross the left screen
        if 0< upperPipes[0]['x'] < 5:
            newPipe = getRandomPipe()
            upperPipes.append(newPipe[0])
            lowerPipes.append(newPipe[1])

        #Remove pipes when they ae about to cross screen
...
if __name__ == "__main__":
    #Main point from where game starts
    pygame.init() # Initialize all pygame modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy bird by Raj')
    ...
    while True:
        welcomeScreen() #This will show welcome screen to the user until he presses any key
